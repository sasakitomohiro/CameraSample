...
class Camera2Loader(private val activity: Activity) {
    companion object {
    ...
    private var cameraFacing: Int = CameraCharacteristics.LENS_FACING_FRONT
    var viewWidth: Int = 0
    ...
    private fun startCaptureSession() {
        ...
        imageReader =
            ImageReader.newInstance(size.width, size.height, ImageFormat.YUV_420_888, 1).apply {
...
//        return Size(maxPreviewWidth, maxPreviewHeight)
    }
